...
#Executado Typeorm
yarn typeorm migration:create -n CreatCustomers
yarn typeorm migration:create -n CreatProducts
yarn typeorm migration:create -n CreatOrders_products
yarn typeorm migration:create -n CreatOrders
yarn typeorm migration:create -n CreatForeignKeyOrders_Products
